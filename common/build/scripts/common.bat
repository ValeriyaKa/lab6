...
set CLASSPATH=%APP_HOME%\lib\common.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\guava-31.1-jre.jar;%APP_HOME%\lib\postgresql-42.2.23.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.12.0.jar;%APP_HOME%\lib\error_prone_annotations-2.11.0.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar


@rem Execute common
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COMMON_OPTS%  -classpath "%CLASSPATH%"  %*
...
if not ""=="%COMMON_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
